    ...
    <div className="lg:w-[50%] w-screen relative m-4    bg-white items-center  min-h-screen flex flex-col justify-between">
      <div className="flex items-center w-[100%] justify-between mb-4 bg-blue-500">
        ...
        <h1 className="text-xl font-semibold">
          <img src={Logo} alt="Conceivable" />
        </h1>
        <div
          className="relative cursor-pointer max-sm:mr-2  mr-5"
        ...
        >
          ...
          />
          {showUserDetails && (
            <div className="absolute -bottom-[90px] right-0 rounded-xl bg-blue-100 w-max text-sm font-semibold ">
              <ul>
                <li className=" mx-2 my-2">👤 {name}</li>
                <li className="my-1 mx-2">📧 {email}</li>
                <hr />
                <div
                  className="bg-blue-300 px-2 py-1 cursor-pointer rounded-b-xl"
                  onClick={() => {
                    handleLogOut();
                  }}
                >
      ...
      <div className="relative h-max">
        ...
        <img
          src={AdminImage}
          alt="Bot"
          className="w-48 h-48 rounded-full z-20 relative"
        />
        {isPlaying && (
          <>
            <div
              className="h-52 w-52 absolute top-1/2 -translate-y-1/2  -translate-x-1/2 left-1/2  bg-blue-500/70 rounded-full animate-pulse"
              style={{
            ...
            ></div>
            <div
              className="h-60 w-60 absolute top-1/2 -translate-y-1/2  -translate-x-1/2 left-1/2 bg-blue-500/70 rounded-full animate-pulse"
              style={{
            ...
            ></div>
            <div
              className="h-72 w-72 absolute top-1/2 -translate-y-1/2  -translate-x-1/2 left-1/2 bg-blue-500/70 rounded-full animate-pulse"
              style={{
        ...
        {isWaiting && (
          <>
            <div
              className="h-52 w-52 absolute transform top-1/2 -translate-y-1/2  -translate-x-1/2 left-1/2  bg-yellow-500/70 rounded-full animate-pulse"
              style={{
                animationDuration: "3s",
                animationIterationCount: "infinite",
              }}
            ></div>
            <div
              className="h-60 w-60 absolute transform top-1/2 -translate-y-1/2  -translate-x-1/2 left-1/2 bg-yellow-500/70 rounded-full animate-pulse"
              style={{
                animationDuration: "2s",
                animationIterationCount: "infinite",
              }}
            ></div>
            <div
              className="h-72 w-72 absolute transform top-1/2 -translate-y-1/2  -translate-x-1/2 left-1/2 bg-yellow-500/70 rounded-full animate-pulse"
              style={{
                animationDuration: "1s",
                animationIterationCount: "infinite",
              }}
            ...
            recording ? (
              <>
                <button
                  ...
                  className="mr-2 px-4 relative py-2 bg-red-500 text-white rounded-full flex justify-center items-center h-[75px] w-[75px] "
                >
                  <Mic />

                  <div>
                    <div
                      className="h-10 w-10 absolute transform top-1/2 -translate-y-1/2  -translate-x-1/2 left-1/2  bg-red-100/70 rounded-full animate-pulse"
                      style={{
                        animationDuration: "3s",
                        animationIterationCount: "infinite",
                      }}
                    ></div>
                    <div
                      className="h-16 w-16 absolute transform top-1/2 -translate-y-1/2  -translate-x-1/2 left-1/2 bg-red-100/70 rounded-full animate-pulse"
                      style={{
                        animationDuration: "2s",
                        animationIterationCount: "infinite",
                      }}
                    ></div>
                    <div
                      className="h-20 w-20 absolute transform top-1/2 -translate-y-1/2  -translate-x-1/2 left-1/2 bg-red-100/70 rounded-full animate-pulse"
                      style={{
                        animationDuration: "1s",
                        animationIterationCount: "infinite",
                      }}
              ...
              <button
                ...
                className="flex justify-center items-center h-[75px] w-[75px] mr-2 px-4 py-2 bg-blue-500 text-white rounded-full"
              >
                <MicOff />
              </button>
            )
